...
public class Queue01 {
    ...
    public static void main(String[] args) {
        ...
        //boş olursa hata vermez
        myQueue.poll();

        //Retrieves and removes the head of this queue. aldığı elemenı siliyor
        // boşlar için exception atar
        //This method differs from poll() only in that it throws an exception if this queue is empty.
        //Returns:the head of this queue.
        myQueue.remove();

        //Retrieves, but does not remove, the head of this queue. copy past yapar
        //This method differs from peek only in that it throws an exception if this queue is empty.
        //bos olursa hata verir
        myQueue.element();

        //Retrieves, but does not remove, the head of this queue, or returns null if this queue is empty.
        //dolu ise elementle aynı .boşsa hata vermez copy past yapar
        myQueue.peek();
       ...
       offer method u kısıtlama varsa ekleme yapamaz
       add method u ise her türlü ekleme yapar
        ...
        //PriorityQueu kendine göre yeni bir sıralama çeşidi yapar
