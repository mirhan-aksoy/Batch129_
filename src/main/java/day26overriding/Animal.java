package day26overriding;
            ...
            6)Child Class'daki override edilmis method(Overriding Method)'un
              ...
              Overridden Method ==> private ise Overriding Method ==> override olmaz ki
              access modifier'i olsun. (Bkz 5. kural)
            7)Child Class'da override edilen method'un(Overriding Method)
             return type'i method'un return ettigi data type'inin aynisi veya o data type'inin
              parent'i olarak secilebilir.
            8)Method'un return type'i "primitive" ise, Overriding yaparken return type degistirilemez.
            Cunku; return type ya ayni olur veya parent'dan secilir ama
              primitive'ler arasinda "parent-child iliskisi" olmadigindan parent'dan secmek mevzu bahis olamaz
            ...
            11) Final (kısır) kelimesini "Variable"larda kullanabilirsiniz.
                        ->final variable ise
                        i) mutlaka değer atanmalıdır
                        ii) ilk atanan değer -başka yerlerde- değiştirilemez
            ...
            16) Method Overloading "Compile Time Polymorphism"(coklu görünüm) dir, Method Overriding "Run Time Polymorphism" dir.
