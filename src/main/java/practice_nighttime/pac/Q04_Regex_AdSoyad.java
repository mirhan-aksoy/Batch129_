...
public class Q04_Regex_AdSoyad {
    ...
    public static void main(String[] args) {
        ...
        String adIlkHarf = ad.substring(0,1).toUpperCase();//A
        String soyAdIlkHarf = soyAd.substring(0,1).toUpperCase();//C

        String adFormatli = adIlkHarf+ad.substring(1);//Ali
        String soyAdFormatli = soyAdIlkHarf+soyAd.substring(1);//Can
